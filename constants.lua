<<<<<<< HEAD
PULL_LENGTH = 300; -- How far player can pull
PULL_LENGTH2 = PULL_LENGTH * PULL_LENGTH; -- Square of how far player can pull
PULL_FORCE = 400; -- Force at which the player pulls the ball
PUSH_COST = 100;
PUSH_COOLDOWN = 5;
...
PLAYER_FORCE = 5000; -- Force put on the player to move the joystick
=======
PULL_LENGTH2 = 325 * 325; -- Square of how far player can pull
