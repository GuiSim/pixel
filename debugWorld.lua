...
local drawnBodies = {}
local function debugWorld_scissor_callback(fixture)
	drawnBodies[fixture:getBody()] = true
	return true --search continues until false
end

local function debugWorld(world,topLeft_x,topLeft_y,width,height)
	world:queryBoundingBox(topLeft_x,topLeft_y,topLeft_x+width,topLeft_y+height,debugWorld_scissor_callback)
